...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "src/rndf_robot/utils/libsimplify/Simplify.h"
        ],
        "include_dirs": [
            "src/rndf_robot/utils/libsimplify"
        ],
        "language": "c++",
        "name": "rndf_robot.utils.libsimplify.simplify_mesh",
        "sources": [
            "src/rndf_robot/utils/libsimplify/simplify_mesh.pyx"
        ]
    },
    "module_name": "rndf_robot.utils.libsimplify.simplify_mesh"
}
END: Cython Metadata */
...
#define __PYX_HAVE__rndf_robot__utils__libsimplify__simplify_mesh
#define __PYX_HAVE_API__rndf_robot__utils__libsimplify__simplify_mesh
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
struct __pyx_opt_args_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify;

/* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":34
 * 
 * 
...
/* Module declarations from 'rndf_robot.utils.libsimplify.simplify_mesh' */
...
static PyObject *__pyx_f_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify(__Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch, struct __pyx_opt_args_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "rndf_robot.utils.libsimplify.simplify_mesh"
extern int __pyx_module_is_main_rndf_robot__utils__libsimplify__simplify_mesh;
int __pyx_module_is_main_rndf_robot__utils__libsimplify__simplify_mesh = 0;

/* Implementation of 'rndf_robot.utils.libsimplify.simplify_mesh' */
...
static PyObject *__pyx_pf_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vertices_in, __Pyx_memviewslice __pyx_v_triangles_in, int __pyx_v_f_target, double __pyx_v_agressiveness); /* proto */
...
static PyObject *__pyx_pw_10rndf_robot_5utils_11libsimplify_13simplify_mesh_1mesh_simplify(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify(__Pyx_memviewslice __pyx_v_vertices_in, __Pyx_memviewslice __pyx_v_triangles_in, int __pyx_v_f_target, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify *__pyx_optional_args) {
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":36
 * cpdef mesh_simplify(double[:, ::1] vertices_in, long[:, ::1] triangles_in,
 *                         int f_target, double agressiveness=7.) except +:
 *     vertices.clear()             # <<<<<<<<<<<<<<
 *     triangles.clear()
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":37
 *                         int f_target, double agressiveness=7.) except +:
 *     vertices.clear()
 *     triangles.clear()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":41
 *     # Read in vertices and triangles
 *     cdef Vertex v
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":42
 *     cdef Vertex v
 *     for iv in range(vertices_in.shape[0]):
 *         v = Vertex()             # <<<<<<<<<<<<<<
 *         v.p.x = vertices_in[iv, 0]
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":43
 *     for iv in range(vertices_in.shape[0]):
 *         v = Vertex()
 *         v.p.x = vertices_in[iv, 0]             # <<<<<<<<<<<<<<
 *         v.p.y = vertices_in[iv, 1]
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":44
 *         v = Vertex()
 *         v.p.x = vertices_in[iv, 0]
 *         v.p.y = vertices_in[iv, 1]             # <<<<<<<<<<<<<<
 *         v.p.z = vertices_in[iv, 2]
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":45
 *         v.p.x = vertices_in[iv, 0]
 *         v.p.y = vertices_in[iv, 1]
 *         v.p.z = vertices_in[iv, 2]             # <<<<<<<<<<<<<<
 *         vertices.push_back(v)
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":46
 *         v.p.y = vertices_in[iv, 1]
 *         v.p.z = vertices_in[iv, 2]
 *         vertices.push_back(v)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":49
 * 
 *     cdef Triangle t
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_2; __pyx_t_8+=1) {
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":50
 *     cdef Triangle t
 *     for it in range(triangles_in.shape[0]):
 *         t = Triangle()             # <<<<<<<<<<<<<<
 *         t.v[0] = triangles_in[it, 0]
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":51
 *     for it in range(triangles_in.shape[0]):
 *         t = Triangle()
 *         t.v[0] = triangles_in[it, 0]             # <<<<<<<<<<<<<<
 *         t.v[1] = triangles_in[it, 1]
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":52
 *         t = Triangle()
 *         t.v[0] = triangles_in[it, 0]
 *         t.v[1] = triangles_in[it, 1]             # <<<<<<<<<<<<<<
 *         t.v[2] = triangles_in[it, 2]
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":53
 *         t.v[0] = triangles_in[it, 0]
 *         t.v[1] = triangles_in[it, 1]
 *         t.v[2] = triangles_in[it, 2]             # <<<<<<<<<<<<<<
 *         triangles.push_back(t)
 ...
 */
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":54
 *         t.v[1] = triangles_in[it, 1]
 *         t.v[2] = triangles_in[it, 2]
 *         triangles.push_back(t)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":58
 *     # Simplify
 *     # print('Simplify...')
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":62
 *     # Only use triangles that are not deleted
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":64
 *     triangles_notdel.reserve(triangles.size())
 * 
 *     for t in triangles:             # <<<<<<<<<<<<<<
 *         if not t.deleted:
 ...
 */
  ...
  for (;;) {
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":65
 * 
 *     for t in triangles:
 *         if not t.deleted:             # <<<<<<<<<<<<<<
 *             triangles_notdel.push_back(t)
 ...
 */
    ...
    if (__pyx_t_12) {
      ...
      /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":66
 *     for t in triangles:
 *         if not t.deleted:
 *             triangles_notdel.push_back(t)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":69
 * 
 *     # Read out triangles
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":70
 *     # Read out triangles
 *     vertices_out = np.empty((vertices.size(), 3), dtype=np.float64)
 *     triangles_out = np.empty((triangles_notdel.size(), 3), dtype=np.int64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":72
 *     triangles_out = np.empty((triangles_notdel.size(), 3), dtype=np.int64)
 * 
 *     cdef double[:, :] vertices_out_view = vertices_out             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":73
 * 
 *     cdef double[:, :] vertices_out_view = vertices_out
 *     cdef long[:, :] triangles_out_view = triangles_out             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":75
 *     cdef long[:, :] triangles_out_view = triangles_out
 * 
 *     for iv in range(vertices.size()):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_5; __pyx_t_20+=1) {
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":76
 * 
 *     for iv in range(vertices.size()):
 *         vertices_out_view[iv, 0] = vertices[iv].p.x             # <<<<<<<<<<<<<<
 *         vertices_out_view[iv, 1] = vertices[iv].p.y
 ...
 */
    ...
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vertices_out_view.data + __pyx_t_22 * __pyx_v_vertices_out_view.strides[0]) ) + __pyx_t_6 * __pyx_v_vertices_out_view.strides[1]) )) = __pyx_t_21;
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":77
 *     for iv in range(vertices.size()):
 *         vertices_out_view[iv, 0] = vertices[iv].p.x
 *         vertices_out_view[iv, 1] = vertices[iv].p.y             # <<<<<<<<<<<<<<
 *         vertices_out_view[iv, 2] = vertices[iv].p.z
 ...
 */
    ...
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vertices_out_view.data + __pyx_t_22 * __pyx_v_vertices_out_view.strides[0]) ) + __pyx_t_6 * __pyx_v_vertices_out_view.strides[1]) )) = __pyx_t_21;
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":78
 *         vertices_out_view[iv, 0] = vertices[iv].p.x
 *         vertices_out_view[iv, 1] = vertices[iv].p.y
 *         vertices_out_view[iv, 2] = vertices[iv].p.z             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":80
 *         vertices_out_view[iv, 2] = vertices[iv].p.z
 * 
 *     for it in range(triangles_notdel.size()):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_23 = 0; __pyx_t_23 < __pyx_t_10; __pyx_t_23+=1) {
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":81
 * 
 *     for it in range(triangles_notdel.size()):
 *         triangles_out_view[it, 0] = triangles_notdel[it].v[0]             # <<<<<<<<<<<<<<
 *         triangles_out_view[it, 1] = triangles_notdel[it].v[1]
 ...
 */
    ...
    *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_triangles_out_view.data + __pyx_t_24 * __pyx_v_triangles_out_view.strides[0]) ) + __pyx_t_6 * __pyx_v_triangles_out_view.strides[1]) )) = ((__pyx_v_triangles_notdel[__pyx_v_it]).v[0]);
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":82
 *     for it in range(triangles_notdel.size()):
 *         triangles_out_view[it, 0] = triangles_notdel[it].v[0]
 *         triangles_out_view[it, 1] = triangles_notdel[it].v[1]             # <<<<<<<<<<<<<<
 *         triangles_out_view[it, 2] = triangles_notdel[it].v[2]
 ...
 */
    ...
    *((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_triangles_out_view.data + __pyx_t_24 * __pyx_v_triangles_out_view.strides[0]) ) + __pyx_t_6 * __pyx_v_triangles_out_view.strides[1]) )) = ((__pyx_v_triangles_notdel[__pyx_v_it]).v[1]);
    ...
    /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":83
 *         triangles_out_view[it, 0] = triangles_notdel[it].v[0]
 *         triangles_out_view[it, 1] = triangles_notdel[it].v[1]
 *         triangles_out_view[it, 2] = triangles_notdel[it].v[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":86
 * 
 *     # Clear vertices and triangles
 *     vertices.clear()             # <<<<<<<<<<<<<<
 *     triangles.clear()
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":87
 *     # Clear vertices and triangles
 *     vertices.clear()
 *     triangles.clear()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":89
 *     triangles.clear()
 * 
 *     return vertices_out, triangles_out             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("rndf_robot.utils.libsimplify.simplify_mesh.mesh_simplify", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_10rndf_robot_5utils_11libsimplify_13simplify_mesh_1mesh_simplify(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10rndf_robot_5utils_11libsimplify_13simplify_mesh_1mesh_simplify(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify(__pyx_self, __pyx_v_vertices_in, __pyx_v_triangles_in, __pyx_v_f_target, __pyx_v_agressiveness);
...
static PyObject *__pyx_pf_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vertices_in, __Pyx_memviewslice __pyx_v_triangles_in, int __pyx_v_f_target, double __pyx_v_agressiveness) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("mesh_simplify", 0);
  ...
  try {
    __pyx_t_1 = __pyx_f_10rndf_robot_5utils_11libsimplify_13simplify_mesh_mesh_simplify(__pyx_v_vertices_in, __pyx_v_triangles_in, __pyx_v_f_target, 0, &__pyx_t_2);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "rndf_robot.utils.libsimplify.simplify_mesh.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "rndf_robot.utils.libsimplify.simplify_mesh.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "rndf_robot.utils.libsimplify.simplify_mesh.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "rndf_robot.utils.libsimplify.simplify_mesh._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"mesh_simplify", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10rndf_robot_5utils_11libsimplify_13simplify_mesh_1mesh_simplify, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_rndf_robot__utils__libsimplify__simplify_mesh) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "rndf_robot.utils.libsimplify.simplify_mesh")) {
      if (unlikely(PyDict_SetItemString(modules, "rndf_robot.utils.libsimplify.simplify_mesh", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":3
 ...
 */
  ...
  /* "rndf_robot/utils/libsimplify/simplify_mesh.pyx":1
 * # distutils: language = c++             # <<<<<<<<<<<<<<
 * from libcpp.vector cimport vector
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rndf_robot.utils.libsimplify.simplify_mesh", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init rndf_robot.utils.libsimplify.simplify_mesh");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
